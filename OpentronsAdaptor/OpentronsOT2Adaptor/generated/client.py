...
from . import opentronsot2controller


class Client(SilaClient):

    OpentronsOT2Controller: opentronsot2controller.OpentronsOT2ControllerClient
    ...
    _expected_features: Set[FullyQualifiedFeatureIdentifier] = {
        ...
        FullyQualifiedFeatureIdentifier("org.silastandard/examples/OpentronsOT2Controller/v1"),
    }
